...
The earth's atmosphere absorbs \jdp{\sout{a large portion of the} certain wavelengths of} solar radiation, some of which (x-ray and ultraviolet) can be quite harmful to humans.
...
The solar surface, referred to as the photosphere, is the base of the solar atmosphere and is defined as the point where photons can escape into space without being reabsorbed by surrounding plasma \jdp{Jiong has doubts, think about this} \citep{Priest2014}.
